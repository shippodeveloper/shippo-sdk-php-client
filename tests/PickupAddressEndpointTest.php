...
class PickupAddressEndpointTest extends BaseTest
{
    ...
    public function testDelete() {
        $pa = $this->endpoint->create([
            'contactName' => 'Đặng Văn Lâm',
            'contactPhone' => '0987654321',
            'locationId' => 37,
            'detailAddress' => 'Số 1 ngõ 2/12 Phố Ta',
        ]);
