...
{
    /**
     * @var \Shippo\Endpoints\DeliveryOrderEndpoint
     */
    private $endpoint;
    ...
    protected function setUp()
    {
        ...
        $this->endpoint = new \Shippo\Endpoints\DeliveryOrderEndpoint($this->getClient());
    }
    ...
    public function testCancel() {
        ...
        $order = $this->endpoint->edit($sampleOrder->orderCode, [
            'state' => \Shippo\Models\DeliveryOrder::STATE_CANCELLED
        ]);

        $this->assertEquals($sampleOrder->id, $order->id);
        $this->assertEquals($sampleOrder->receiverName, $order->receiverName);
        $this->assertEquals(\Shippo\Models\DeliveryOrder::STATE_CANCELLED, $order->state);
    }
    ...
    private function _createDeliveryOrder(): \Shippo\Models\DeliveryOrder {
        //create pickup address first
        $pa = $this->_createPickupAddress();
